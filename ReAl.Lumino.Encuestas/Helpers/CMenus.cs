...
namespace ReAl.Lumino.Encuestas.Helpers
{
    public static class CMenus
    {
        ...
        public static List<SegAplicaciones> GetAplicaciones(db_encuestasContext context)
        {
            return context.SegAplicaciones.OrderBy(x => x.Nombre) .ToList();            
        }
        
        public static List<SegPaginas> GetPages(HttpContext miContexto, db_encuestasContext context)
        {
            string currentApp = "--";
